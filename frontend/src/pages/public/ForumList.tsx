          ...
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
            <div>
              ...
              <p className="text-black text-sm sm:text-base">
                Diskusikan, tanyakan, dan bagikan tentang dunia parfum bersama
                komunitas.
              </p>
            </div>
            {user && (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        <div className="mb-6 space-y-4">
          ...
          <form onSubmit={handleSearch} className="relative">
            ...
            />
            <svg
              className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-black"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          {loading ? (
            ...
            Array.from({ length: 6 }).map((_, i) => (
              <div
                key={i}
                className="p-6 rounded-xl bg-white border border-gray-100 animate-pulse h-32"
              >
            ...
            <div className="text-center py-20">
              ...
              <p className="text-black font-medium mb-1">Belum ada topik</p>
