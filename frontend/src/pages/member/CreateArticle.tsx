          ...
          <form onSubmit={handleSubmit} className="p-6 sm:p-8 space-y-6">
              ...
              <label className="flex flex-col items-center justify-center w-full h-40 border-2 border-dashed border-gray-200 rounded-xl cursor-pointer hover:border-indigo-300 hover:bg-indigo-50/30 transition-all">
                {imagePreview ? (
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-xs text-gray-400">Klik untuk upload cover image</p>
                  </div>
                )}
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-3 rounded-xl bg-gray-50 border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-200 focus:border-indigo-400 resize-none transition-all leading-relaxed"
              />
            </div>
