          ...
          <form onSubmit={handleSubmit} className="p-6 sm:p-8 space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-3 rounded-xl bg-gray-50 border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-amber-200 focus:border-amber-400 resize-none transition-all leading-relaxed"
              />
            </div>
